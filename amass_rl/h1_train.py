...
def get_cfgs():
    env_cfg = {
        ...
        "termination_track_rb_threshold": 0.5,
    ...
    obs_cfg = {
        "num_obs": 3+3+19+19+60+80+60+60+19+19+19,
        "num_privileged_obs": 3+3+3+19+19+60+80+60+60+19+19+19,
